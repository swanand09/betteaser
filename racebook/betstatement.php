...
<html>
    <head>
        ...
        <script src="js/bstatement.js"></script>
    </head>
    <body>
                     ...
                     <div id="slidebanner-left">
                         <div id="betSlip">
                             ...
                             <?php
                                ...
                                $tableBetSlip.='</table><div class="sp"></div><div id="stment"><a href="betstatement.php">Bet List</a><div class="sp"></div><a href="#">Fund Statement</a><div class="sp"></div><a href="statement.php">Statement</a></div>';
                                if($i==0){
                ...
                <div id="racebookContent">
                    <div id="testRace">
                        ...
                        <div id="raceDetails">
                            ...
                            <h4 id="mtingName" style='float: left; margin-top: 4px; width: 400px;'></h4>
                            <br/><br/><br/><a class='viewRacecard' id='sel' href='#' >All Bets</a>&nbsp;&nbsp;<a class='viewRacecard' href='#' >Pending Bets</a>&nbsp;&nbsp;<a class='viewRacecard' href='#' >Replaced Bets</a>&nbsp;&nbsp;<a class='viewRacecard' href='#' >Refund Bets</a>&nbsp;&nbsp;<a class='viewRacecard' href='#' >Won</a>&nbsp;&nbsp;<a class='viewRacecard' href='#' >Lost</a><br/><br/>
                            </div>
                            <div id="allBets">
                                <div class="demo_jui">
                                <?php
                                    ...
                                    $bSlipBet=Bet::getBetForBSlip(0,$clId[0]['_id_client']);
                                    $tabAllBets="<table id='tblAllBets-a' class='display'><thead><tr class='hdr'><th><b>Played Date</b></th><th><b>Stake (".$bSlipBet[0]['_curr'].")</b></th><th><b>Selection</b></th><th><b>Potential Payout</b></th><th><b>Payout (".$bSlipBet[0]['_curr'].")</b></th><th><b>Bet Type</b></th><th><b>Status</b></th></tr></thead>";

                                    foreach($bSlipBet as $b){
                                        $playedDate=date("d M Y H:i", strtotime($b['_date']));
                                        $strAccBet= str_replace($rh, $newCarac, $b['_betrnumacc']);
                                        $ppo=Sel::getSelPO($b['_id_bet'], $b['_fold']);
                                        $tabAllBets.="<tr class='gradeA'>";
                                            $tabAllBets.="<td>".$playedDate."</td>";
                                            $tabAllBets.="<td>".$b['_amount']."</td>";
                                            $tabAllBets.="<td>".$strAccBet."</td>";
                                            $tabAllBets.="<td>".$ppo[0]['_ppayout']."</td>";
                                            if($ppo[0]['_winamount']!=0){
                                                $tabAllBets.="<td>".$ppo[0]['_winamount']."</td>";
                                            }else{
                                                $tabAllBets.="<td>-</td>";
                                            }
                                            if($b['_gametype']=='w'){
                            ...
                            <div id="pBets">
                                ...
                                <?php
                                    ...
                                    $bSlipBet=Bet::getBetForBSlip(0,$clId[0]['_id_client']);
                                    $tabAllBets="<table id='tblAllBets-p' class='display'><thead><tr class='hdr'><th><b>Played Date</b></th><th><b>Stake (".$bSlipBet[0]['_curr'].")</b></th><th><b>Selection</b></th><th><b>Potential Payout</b></th><th><b>Payout (".$bSlipBet[0]['_curr'].")</b></th><th><b>Bet Type</b></th><th><b>Status</b></th></tr></thead>";
                            ...
                            <div id="rplBets">
                                ...
                                <?php
                                    ...
                                    $bSlipBet=Bet::getBetForBSlip(0,$clId[0]['_id_client']);
                                    $tabAllBets="<table id='tblAllBets-rpl' class='display'><thead><tr class='hdr'><th><b>Played Date</b></th><th><b>Stake (".$bSlipBet[0]['_curr'].")</b></th><th><b>Selection</b></th><th><b>Potential Payout</b></th><th><b>Payout (".$bSlipBet[0]['_curr'].")</b></th><th><b>Bet Type</b></th><th><b>Status</b></th></tr></thead>";
                            ...
                            <div id="rfnBets">
                                ...
                                <?php
                                    ...
                                    $bSlipBet=Bet::getBetForBSlip(0,$clId[0]['_id_client']);
                                    $tabAllBets="<table id='tblAllBets-rfb' class='display'><thead><tr class='hdr'><th><b>Played Date</b></th><th><b>Stake (".$bSlipBet[0]['_curr'].")</b></th><th><b>Selection</b></th><th><b>Potential Payout</b></th><th><b>Payout (".$bSlipBet[0]['_curr'].")</b></th><th><b>Bet Type</b></th><th><b>Status</b></th></tr></thead>";
                            ...
                            <div id="wonBets">
                                ...
                                <?php
                                    ...
                                    $bSlipBet=Bet::getBetForBSlip(0,$clId[0]['_id_client']);
                                    $tabAllBets="<table id='tblAllBets-won' class='display'><thead><tr class='hdr'><th><b>Played Date</b></th><th><b>Stake (".$bSlipBet[0]['_curr'].")</b></th><th><b>Selection</b></th><th><b>Potential Payout</b></th><th><b>Payout (".$bSlipBet[0]['_curr'].")</b></th><th><b>Bet Type</b></th><th><b>Status</b></th></tr></thead>";
