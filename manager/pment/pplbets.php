...
if($flEor==1){
    ...
    if($flRez==1){
        ...
        for($i=1;$i<=$rnum;$i++){
                ...
                $lostHorseRez=Horse::getNonPlHorses($endedRaceId);
                $lostHorseId=array();
                ...
                for($j=1;$j<=9;$j++){
                    ...
                    $qryUpLostHorse="UPDATE _sel".$j."_tb SET _bselstatus=2, _winamount=0 WHERE _btype='p' AND _bselstatus=0 AND (".$mergedLostHorse.")";
        ...
        for($a=1;$a<=$rnum;$a++){
            ...
            $tmpWinRez1 = Horse::getResultPlace($r1Id);
            $winHorseId1 = array();
            ...
            $qryFold['1f']['po'][]=" _ppayout*(select _hplacerate from _horse_tb where _ref_horse1=_id_horse)*".$WopFactor1;
        
            for($b=$a+1;$b<=$rnum;$b++){
                $EorRez=Race::checkEoRByRnum($b,$refMeeting);
                $r2Id = $EorRez[0]['_id_race']; //raceId
                $tmpWinRez2 = Horse::getResultPlace($r2Id);
                $winHorseId2 = array();
                ...
                $qryFold['2f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*".($WopFactor1*$WopFactor2);
            
                for($c=$b+1;$c<=$rnum;$c++){
                    $EorRez=Race::checkEoRByRnum($c,$refMeeting);
                    $r3Id = $EorRez[0]['_id_race']; //raceId
                    $tmpWinRez3 = Horse::getResultPlace($r3Id);
                    $winHorseId3 = array();
                    ...
                    $qryFold['3f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3);
                
                    for($d=$c+1;$d<=$rnum;$d++){
                        $EorRez=Race::checkEoRByRnum($d,$refMeeting);
                        $r4Id = $EorRez[0]['_id_race']; //raceId
                        $tmpWinRez4 = Horse::getResultPlace($r4Id);
                        $winHorseId4 = array();
                        ...
                        $qryFold['4f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse4=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3*$WopFactor4);
                    
                        for($e=$d+1;$e<=$rnum;$e++){
                            $EorRez=Race::checkEoRByRnum($e,$refMeeting);
                            $r5Id = $EorRez[0]['_id_race']; //raceId
                            $tmpWinRez5 = Horse::getResultPlace($r5Id);
                            $winHorseId5 = array();
                            ...
                            $qryFold['5f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse4=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse5=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3*$WopFactor4*$WopFactor5);
                        
                            for($f=$e+1;$f<=$rnum;$f++){
                                $EorRez=Race::checkEoRByRnum($f,$refMeeting);
                                $r6Id = $EorRez[0]['_id_race']; //raceId
                                $tmpWinRez6 = Horse::getResultPlace($r6Id);
                                $winHorseId6 = array();
                                ...
                                $qryFold['6f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse4=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse5=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse6=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3*$WopFactor4*$WopFactor5*$WopFactor6);
                            
                                for($g=$f+1;$g<=$rnum;$g++){
                                    $EorRez=Race::checkEoRByRnum($g,$refMeeting);
                                    $r7Id = $EorRez[0]['_id_race']; //raceId
                                    $tmpWinRez7 = Horse::getResultPlace($r7Id);
                                    $winHorseId7 = array();
                                    ...
                                    $qryFold['7f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse4=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse5=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse6=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse7=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3*$WopFactor4*$WopFactor5*$WopFactor6*$WopFactor7);
                                
                                    for($h=$g+1;$h<=$rnum;$h++){
                                        $EorRez=Race::checkEoRByRnum($h,$refMeeting);
                                        $r8Id = $EorRez[0]['_id_race']; //raceId
                                        $tmpWinRez8 = Horse::getResultPlace($r8Id);
                                        $winHorseId8 = array();
                                        ...
                                        $qryFold['8f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse4=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse5=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse6=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse7=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse8=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3*$WopFactor4*$WopFactor5*$WopFactor6*$WopFactor7*$WopFactor8);
                                    
                                        for($l=$h+1;$l<=$rnum;$l++){
                                            $EorRez=Race::checkEoRByRnum($l,$refMeeting);
                                            $r9Id = $EorRez[0]['_id_race']; //raceId
                                            $tmpWinRez9 = Horse::getResultPlace($r9Id);
                                            $winHorseId9 = array();
                                            ...
                                            $qryFold['9f']['po'][]=" _ppayout*(SELECT _hplacerate from _horse_tb where _ref_horse1=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse2=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse3=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse4=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse5=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse6=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse7=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse8=_id_horse)*(SELECT _hplacerate from _horse_tb where _ref_horse9=_id_horse)*".($WopFactor1*$WopFactor2*$WopFactor3*$WopFactor4*$WopFactor5*$WopFactor6*$WopFactor7*$WopFactor8*$WopFactor9);
                                        }
                                    }
                                }
                            }
...
//        echo '</pre>';
        ...
        for($i=1;$i<=$rnum;$i++){
            ...
            for($j=0;$j<$numQry;$j++){
                $qryUpd="UPDATE _sel".$i."_tb SET _bselstatus=1, _windate='".$winDate."', _winamount=round(".$qryFold[$i.'f']['po'][$j].",2) WHERE ".$qryFold[$i.'f']['w'][$j]." AND _bselstatus=0 AND _btype='p'";
                echo '<br/>'.$qryUpd;
                //Uncomment below
                Sel::execUpdate($qryUpd);
                
                $qrySelWinBets="SELECT _ref_bet, _winamount FROM _sel".$i."_tb WHERE ".$qryFold[$i.'f']['w'][$j]." AND _bselstatus=1 AND _btype='p' AND _windate='".$winDate."'";
